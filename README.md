...
```bash
wget -N https://raw.githubusercontent.com/svip7788/V2bX-script/master/install.sh && bash install.sh
```

### 手动安装

从 [Releases](https://github.com/svip7788/V2bX/releases) 下载对应平台的二进制文件。
